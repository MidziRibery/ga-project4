...
//to create a YUP validation schema, to determine the shape of how the form library is going to save this information. 
//basically this is like the backend schema, we define the type and what is required
